    ...
    <div class="col-md-10">
        <div class="Video">
            <button type="submit"
                    ...
                    class="btn btn-primary mb-2 Botton">CONNECT
            </button>
            ...
            <button type="submit"
                    ...
                    class="btn btn-danger mb-2 Botton">LEAVE
            </button>
    ...
    methods: {
        ...
        async getAccessToken() {
            return await axios.get(
                `${DOMAIN_URL}/api/access_token?identity=${this.username}&room_name=${this.room_name}`
            );
        },
